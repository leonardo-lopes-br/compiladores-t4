...
// Importações
import static br.ufscar.dc.compiladores.t4.ParserUtils_T4.verificarTipo;
import static br.ufscar.dc.compiladores.t4.ParserUtils_T4.adicionaErroSemantico;
import static br.ufscar.dc.compiladores.t4.ParserUtils_T4.verificaCompatibilidade;
import br.ufscar.dc.compiladores.t4.TabelaDeSimbolos.TipoEntrada;
import br.ufscar.dc.compiladores.t4.TabelaDeSimbolos.Tipos;
import org.antlr.v4.runtime.Token;
import java.util.ArrayList;
import java.util.HashMap;

// Classe do Parser para visitar a árvore da gramática
public class Parser_T4 extends LABaseVisitor<Void> {
